...
namespace vincontrol.Application.ViewModels.AccountManagement
{
    public class UserRoleViewModel 
    {
        ...
        public string IsUserNameExist { get; set; }

        public string IsUserEmailExist { get; set; }
        ...
        public string CellPhoneWithNumberOnly
        {
            get { return String.IsNullOrEmpty(Cellphone) ? string.Empty : Regex.Replace(Cellphone, "[^a-zA-Z0-9]+", "", RegexOptions.Compiled); }
        }
