        ...
        <div class="content">
            <div class="dashboard-tab page-tab">
                    ...
                    <ul class="video-list">
                        <li>
                            <div class="video-thumb">
                                <img src="/Content/Images/social/sample-video-thumb.jpg">
                            </div>
                ...
                <div class="video-views-box">
                    ...
                    <div class="views-graph-canvas">
                        <img src="/Content/Images/social/graph-sample.jpg">
                    </div>
                        ...
                        <div class="share-online">
                            ...
                            <div class="social-site-selection">
                                ...
                                <ul class="social-sites-listing">
                                    <li>
                                        <img src="/Content/Images/social/youtube-sml.png">
                                        <br>
                                        <input type="checkbox">
                                    </li>
                                    <li>
                                        <img src="/Content/Images/social/facebook-sml.png">
                                        <br>
                                        <input type="checkbox">
                                    </li>
                                    <li>
                                        <img src="/Content/Images/social/twitter-sml.png">
                                        <br>
                                        <input type="checkbox">
                                    </li>
                                </ul>
                ...
                <div class="scrollableContainer">
                    <div class="scrollingArea">
                        <table class="list" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="video-title" width="300">
                                        <span class="ico">Random Video Title Goes Right Here</span>
                                    </td>
                                    <td class="video-views" width="80">
                                        25k
                                    </td>
                                    <td class="video-watch-time" width="80">
                                        1.1m
                                    </td>
                                    <td class="video-likes" width="80">
                                        88k
                                    </td>
                                    <td class="video-dislikes" width="80">
                                        15k
                                    </td>
                                    <td class="video-comments" width="80">
                                        34k
                                    </td>
                                    <td class="video-favorites" width="80">
                                        74k
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="popup hidden preview-video-popup">
                <div class="popup-wrap">
                    <h3>
                        Preview Video</h3>
                    <iframe width="550" height="315" src="http//www.youtube.com/embed/QZNeXL8H8JE" frameborder="0"
                        allowfullscreen></iframe>
                    <div class="popup-keywords">
                        <b>Keywords:</b> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                        quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                        fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa
                        qui officia deserunt mollit anim id est laborum. <a href="">...Read More</a>
                    </div>
...
<link href="<%=Url.Content("~/Content/social/video.css")%>" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ClientScripts" runat="server">
    <script type="text/javascript">
        $("#nav").find(".youtube").addClass("active");
    </script>
</asp:Content>
