...
namespace vincontrol.TaskScheduler
{
    ...
    public class TaskList : IEnumerable, IDisposable
    {
        ...
        private class Enumerator : IEnumerator
        {
            ...
            /// <summary>
            /// Internal constructor - Only accessable through <see cref="IEnumerable{T}.GetEnumerator()"/>
            /// </summary>
            ...
            /// <summary>
            /// Moves to the next task. See <see cref="IEnumerator{T}.MoveNext()"/> for more information.
            /// </summary>
            ...
            /// <summary>
            /// Reset task enumeration. See <see cref="IEnumerator{T}.Reset()"/> for more information.
            /// </summary>
            public void Reset()
            {
                curIndex = -1;
            ...
            /// <summary>
            /// Retrieves the current task.  See <see cref="IEnumerator{T}.Current"/> for more information.
            /// </summary>
