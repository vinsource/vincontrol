...
namespace vincontrol.TaskScheduler
{
    ...
    public class TriggerList : IList, IDisposable
    {
        ...
        private class Enumerator : IEnumerator
        {
            ...
            /// <summary>
            /// Internal constructor - Only accessible through <see cref="IEnumerable{T}.GetEnumerator()"/>.
            /// </summary>
            ...
            /// <summary>
            /// Moves to the next trigger. See <see cref="IEnumerator{T}.MoveNext()"/> for more information.
            /// </summary>
            ...
            /// <summary>
            /// Reset trigger enumeration. See <see cref="IEnumerator{T}.Reset()"/> for more information.
            /// </summary>
            public void Reset()
            {
                currentIndex = -1;
            ...
            /// <summary>
            /// Retrieves the current trigger.  See <see cref="IEnumerator{T}.Current"/> for more information.
            /// </summary>
