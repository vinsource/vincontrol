    ...
    public partial class LoadingForm : Form
    {
        ...
        private void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                var ftpDatafeedCredential = new NetworkCredential(System.Configuration.ConfigurationManager.AppSettings["DatafeedFTPUsername"].ToString(CultureInfo.InvariantCulture), System.Configuration.ConfigurationManager.AppSettings["DatafeedFTPPassword"].ToString(CultureInfo.InvariantCulture));
