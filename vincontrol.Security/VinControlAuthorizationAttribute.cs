...
namespace vincontrol.Security
{
    ...
    /// <para>[VinControlAuthorizationAttribute(PermissionCode = "AMMRETSE", AcceptedValues = "ALLACCESS")]</para>
    /// <para>Multiple Accepted Values:</para>
    /// <para>[VinControlAuthorizationAttribute(PermissionCode = "AMMRETSE", AcceptedValues = "READONLY, ALLACCESS")]</para>
    /// </example>
