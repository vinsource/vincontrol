...
using VINCONTROL.Silverlight.Commands;
...
namespace VINCONTROL.Silverlight.ViewModels
{
    public class UploadViewModel : INotifyPropertyChanged
    {
        ...
        {
            if (String.IsNullOrEmpty(((App)Application.Current).Vin))
            {
        ...
        private void Intialize()
        {
            ...
            var r = new Random();
            uriBuilder.Query = string.Format("Function=GetImageUrlList&ListingId={0}&r={1}", ((App)Application.Current).ListingId, r.Next());
