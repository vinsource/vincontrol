...
<head>
    ...
    <script type="text/javascript">
        ...
        function Paging(i) {
            ...
            $.ajax({
                type: "POST",
                url: "/Manheim/ManheimReportDetail?year=" + year + "&make=" + make + "&model=" + model + "&trim=" + trim + "&region=" + region + "&pageIndex=" + (i) + "&pageSize=" + pageSize,
                data: {},
                success: function (results) {
        ...
        function ExportFile(reportType) {
            ...
            window.location.href = "/Manheim/PrintManheimReportDetail?year=" + year + "&make=" + make + "&model=" + model + "&trim=" + trim + "&regionValue=" + region + "&regionName=" + regionName + "&reportType=" + reportType;
