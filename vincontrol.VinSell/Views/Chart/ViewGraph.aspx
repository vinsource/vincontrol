...
<head>
    ...
    <script src="<%=Url.Content("~/Scripts/extension.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/fancybox/jquery.fancybox-1.3.4.pack.js")%>"
        type="text/javascript"></script>
    <link href="<%=Url.Content("~/Scripts/fancybox/jquery.fancybox-1.3.4.css")%>" rel="stylesheet"
        type="text/css" media="screen" />
    <link href="<%=Url.Content("~/Scripts/Chart/ui.dropdownchecklist.standalone.css")%>"
        rel="stylesheet" type="text/css" media="screen" />
    <script src="<%=Url.Content("~/Scripts/Chart/jquery.flot.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/excanvas.compiled.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/jquery.flot.symbols.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/jquery.flot.functions.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/jquery.blockUI.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/jquery-ui-1.8.16.custom.min.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/ui.dropdownchecklist-1.4-min.js")%>"
        type="text/javascript"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/d3/d3.js")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/aight/aight.js")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/aight/aight.d3.js")%>"></script>
    <%--<script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/jquery.js")%>"></script>--%>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/return-large.js")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/libs/func.js")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/V3Chart/chart.js")%>"></script>
    <style type="text/css">
        body
        {
            background: #eeeeee;
...
<body>
    <% using (Html.BeginForm("PrintGraphInfo", "PDF", null, FormMethod.Post, new { id = "myform" }))
       { %>
       <input type="hidden" id="vinnumber" name="vinnumber" value="<%=Model.Vin %>" />
    ...
    <div id="result">
        ...
        <div>
            ...
            <%--<a id="seeNationwideMarketData" href="<%=Url.Content("~/Chart/NavigateToNationwide?ListingId=")%><%=ViewData["ListingId"]%>">Click here to see nationwide market data</a>--%>
            <a id="seeNationwideMarketData" href="javascript:;">Click here to see nationwide market
                data</a>
        </div>
        <div id="rangeNav">
            <span class="selected" id="100">100</span> <span id="nation">State</span>
        </div>
        <div id="filter-wrap">
            <%--Options
            ...
            <input type="radio" id="independant" name="dealertype" key="independant" />Independant
            <input type="button" id="btnSave" name="btnSave" value="Save Selections" />
            <a id="checkCARFAX" href="javascript:;">Check CARFAX</a>
            <br />
        </div>
        <div id="chart">
        </div>
    ...
    <script src="http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/src/markerclusterer_compiled.js"
        type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/VINGoogleMap.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/graph_plotter.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/LoadFilterAndEvents.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/ViewGraph.js")%>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var waitingImage = '<%= Url.Content("~/Content/ajax-loader1.gif") %>';
        ...
        //            miles: 30500,
        //            price: 17559,
        //            vin: '12457GFD85S64S8E7'
        //        }];
        $(document).ready(function (e) {
            $("#checkCARFAX").live('mouseover', function () {
                //                alert("duyvo");
                //            alert($selectedCar.autotraderlistingurl);
//                console.log('url');
//                console.log($selectedCar.autotraderlistingurl);
                $("#checkCARFAX").fancybox({
                    href: '/Chart/ViewCarfax?Url=' + encodeURIComponent($selectedCar.autotraderlistingurl),
                    'type': 'iframe',
