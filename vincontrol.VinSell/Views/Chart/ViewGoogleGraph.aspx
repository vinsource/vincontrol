...
<head>
    ...
    <link href="<%=Url.Content("~/Scripts/Chart/ui.dropdownchecklist.standalone.css")%>" rel="stylesheet"
        type="text/css" media="screen" />
    ...
    <script src="<%=Url.Content("~/Scripts/Chart/ui.dropdownchecklist-1.4-min.js")%>" type="text/javascript"></script>
    <style type="text/css">
        body
        {
            background: #eeeeee;
...
<body>
   ...
   <input type="hidden" id="CarListingId" name="listingId" />
    ...
    <script type="text/javascript">
              var dealerLongtitude = <%=SessionHandler.User.DealerLongtitude%>;
         var dealerLatitude = <%=SessionHandler.User.DealerLatitude%>;
    </script>
    <script src="<%=Url.Content("~/Scripts/Chart/VINGoogleMap.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/google_map_graph_plotter.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/LoadFilterAndEvents.js")%>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Scripts/Chart/ViewGoogleGraph.js")%>" type="text/javascript"></script>
