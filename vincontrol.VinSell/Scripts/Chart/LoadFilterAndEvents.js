...
//                    });
    ...
    $("#btnSave").click(function () {
        ...
        var url = "/Chart/SaveSelections?listingId=" + listingId + "&isCarsCom=" + isCarscom + "&options=" + options + "&trims=" + trims + "&isCertified=" + isCertified + "&isAll=" + isAll + "&isFranchise=" + isFranchise + "&isIndependant=" + isIndependant + "&screen=" + chartType + "&vin=" + vinnumber;
