...
{
    public class AdditionalReviewPost : ObjectBase
    {
        #region XmlElements
        ...
        [XmlElement("reasonForVisit")]
        public MatchType ReasonForVisit;

        [XmlElement("recommendThisDealer")]
        public MatchType RecommentThisDealer;

        [XmlElement("purchasedAVehicle")]
        public MatchType PurchasedAVehicle;
