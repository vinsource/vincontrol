<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfitManagementReport.aspx.cs" Inherits="WhitmanEnterpriseMVC.ReportTemplates.ProfitManagementReport" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="ReportTemplates\ProfitManagementReport.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="VinObject1" runat="server" 
            SelectMethod="GetProfitManagement" 
