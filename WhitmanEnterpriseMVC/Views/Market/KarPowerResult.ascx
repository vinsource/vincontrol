<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<WhitmanEnterpriseMVC.Models.KarPowerViewModel>" %>
...
<table border="0" cellpadding="2" cellspacing="2" width="750px" style="background-color:#E8CB95">
    ...
    <tr>
        <td>Model</td>
        <td><%= Html.DropDownListFor(m => m.SelectedModelId, Model.Models, new { @class = "dropdownlist", disabled = true })%></td>
        <td>Drive Train</td>
...
<div style="width:750px; margin-top:5px; text-align: right">
    <font style="color:white;">Report:</font>&nbsp; <%= Html.DropDownListFor(m => m.SelectedReport, Model.Reports, new { @class = "dropdownlist" })%> &nbsp;
