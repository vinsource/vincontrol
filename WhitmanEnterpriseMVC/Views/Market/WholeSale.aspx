...
<style type="text/css">
#c2 {width: 784px;}
h4 {margin-bottom: 0; color: white;}
table {width: 784px; font-size: .8em; overflow:visible;}
tr.l {background: #222; margin: 0;}
tr.d {padding-top: .2em; padding-bottom: .3em; margin: 0;}
.listHeader {background: black; text-align: center;}
.none {float: right; color: #999; margin-right: .3em;}
.hider {display: none;}
.fit {width: 100px;}
#purchases input{width: 100%; min-width: 67px;}
#name {width: 200px;}
#wholesaleList input[type="text"]{width:50px;}
#Username {width: 100px;}
tr.space td {height: 10px; border-top: #ddd solid 5px;}
input.save {padding: .5em; font-weight: bold;}
body {background: url('../images/cBgRepeatW.png') top center repeat-y;}
#c2 {border-right: none;}
#listed {height: 400px; overflow: scroll; overflow-x: hidden;}
.delete {width: 50px;}
.num {width: 40px;}
.color { width: 100px; background: #C33; font-weight: bold; text-align: center; color: black; }
#search {float: right;}
#search input[name="search"]{width: 200px;}
#topNav input[type="button"] {border-bottom: 5px solid black; background: #000; padding: .4em; padding-bottom: 0; font-weight: bold; font-size:1em;}
#topNav input[type="button"]:hover {background: #860000;}
input.on {border-bottom: 5px solid #860000 !important;}
</style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div id="wholesaleList" class="hider">
                	...
                	Sort: <select name="sortSet" >
                        	<option value=""> Make (Default) </option>
                            <option value=""> Model </option>
                            <option value=""> Year  </option>
                            <option value=""> Market </option>
                        </select> <a href="">View Favorites</a>
                        <div id="search">Search: <input type="text" name="search"  /></div>
                        ...
                        <table id="header">
                            ...
                            <tr class="l">
                                ...
                                <td>100</td>
                                <td>$15,000</td>
                                <td><input type="text" name="bidAmount" value="550,000" /></td>
                                <td><input type="submit" name="bid" value="Bid"  /></td>
                                <td>
                                	<center><input type="checkbox" name="track" /></center>
                                </td>
                            </tr>
                        </table>
                </div>
