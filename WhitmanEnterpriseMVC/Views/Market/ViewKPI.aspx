...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="topNav">
        <input class="btn onadmin" type="button" name="preownedKPI" value=" Pre-Owned " id="btnPreowned" />
        <input class="btn" type="button" name="newKPI" value=" New " id="btnNew" />
    </div>
    <h3>
        Key Performance Index</h3>
    <div id="gauges">
    ...
    <div id="figures">
        <div id="market" class="column">
            <h3>
                Inventory vs. Market</h3>
            <div id="red" class="colorBar">
                ...
                <div class="%">
                    ...
                    (<%=Html.DynamicHtmlLabelForKPI("txtAboveMarket", "AboveMarket")%>)</div>
            </div>
            <br />
            <div id="green" class="colorBar">
                <div class="text">
                    At Market</div>
                <div class="symbol" id="symbol">
                </div>
                <div class="%" id="percent">
                    <%=Html.DynamicHtmlLabelForKPI("txtPercentAverageMarket", "PercentAverageMarket")%>
                    (<%=Html.DynamicHtmlLabelForKPI("txtAverageMarket", "AverageMarket")%>)</div>
            </div>
            <br />
            <div id="blue" class="colorBar">
                <div class="text">
                    Below Market</div>
                <div class="symbol">
                </div>
                <div class="%">
                    ...
                    (<%=Html.DynamicHtmlLabelForKPI("txtBelowMarket", "BelowMarket")%>)</div>
            </div>
        </div>
    ...
    <div id="activity" class="clear">
        ...
        <div style="font-size:0.9em;margin-bottom:5px;">
            <div style="float: left; width: 110px;font-style:italic;overflow:hidden;"><%= item.UserStamp %>:</div>
            <div style="width: 100%;font-style:italic;margin-left:130px;"><%= item.Title %></div>
        ...
        <br />
        <h3>
            List of Cars <a class="iframe" href=<%=Url.Content("~/Report/PrintOption?Condition=Used")%> style="background-color: #666;
    ...
    <script type='text/javascript'>
        ...
        function drawChart() {
            ...
            //            data.addRows(3);
            //            data.setValue(0, 0, 'Inventory');
            //            data.setValue(0, 1, numberInventory);
            //            data.setValue(1, 0, 'Content');
            //            data.setValue(1, 1, numberContent);
            //            data.setValue(2, 0, 'Website');
          ...
          ['Website', 50]
            ...
            //            var guage;
            //            gauge = new google.visualization.Gauge(document.getElementById('iHealth'));
            //            gauge.draw(data, options);
        }

        //                                 function changeGauge(n, v) {
        //                                     data.setValue(1, 0, n);
        //                                     data.setValue(1, 1, v);
        //                                     gauge.draw(data, options);
        //                                 }

        //                                 changeGauge(name, value);

        //                                 var oldValue;

        //                                 $('input[name="pics"]').click(function() {
        //                                     //oldValue = value;
        //                                     name = 'Pictures';
        //                                     value = 50;
        ...
        //                                     }
        //                                 });
        //                                 $('input[name="desc"]').click(function() {
        //                                     oldValue = value;
        //                                     name = 'Description';
        //                                     value = 25;
