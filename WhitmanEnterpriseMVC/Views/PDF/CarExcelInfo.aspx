<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<WhitmanEnterpriseMVC.Models.CarExcelInfoPrintViewModel>" %>
    ...
    <div id="printable-list">
        <div id="vehicle-list" style="font-size: 12pt">
            <table>
                ...
                <% foreach (var item in Model.CarInfoList.Where(x => !x.Reconstatus).OrderBy(x => x.Make))
                   { %>
                <tr>
                    <td class="padding-right">
