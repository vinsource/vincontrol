...
<input type="hidden" id="NeedToReloadPage" name="NeedToReloadPage" value="false" />        
 				...
 				<div id="dropdownWrap">		
                       ...
                       <div class="clear"></div>
                        ...
                        <%if(Model.VinGenie.HasValue && Model.VinGenie.Value){ %>
                        <a class="pad_tab" title="Print" href="<%= Url.Content("~/PDF/PrintAppraisal/" +Model.AppraisalID) %>">Print Inspection Form</a>
                        <%} %>
                         </div>
                <div id="detailWrap">            
               ...
               <div id="profileInfo">
                    ...
                    <ul class="column">
                        ...
                        <li style="width:140px;"><%=  Html.DynamicHtmlLabel("txtLabelLocation", "Location")%></li>
                    </ul>
                    <ul class="column">
            ...
            <div id="figures">
                        ...
                        <div id="graph" class="column" style="font-size: .8em;
                        	...
                        	<div id="rangeNav"><input type="button" style="margin-left: 0;" id="graphButton" name="toggleGraph" value="Expand" />  <span id="txtDistance">Within (100 miles) from your location</span>
              ...
              <div id="report-wrapper" style="
                      ...
                      <ul>
                            ...
                            <%} %>
                              ...
                              <a href="JavaScript:newPopup('http://www.carfaxonline.com/cfm/Display_Dealer_Report.cfm?partner=VIT_0&UID=<%=Model.CarFaxDealerId%>&vin=<%=Model.VinNumber%>')">View
                            Full Report</a>
                    </div>
                </div>
       ...
       <a target="_blank" style="padding-right: 15px;" target="_blank" title="MMR Auction Pricing"
           ...
           <% }
                           ...
                           <div class="partialContents" data-url="<%= Url.Action("ManheimDataOnMobile", "Appraisal", new { listingId = Model.AppraisalGenerateId }) %>">
                            ...
                            <div id="kbb">
                                ...
                                <div id="divPartialKbb" class="partialContents" data-url="<%= Url.Action("KarPowerDataOnMobile", "Appraisal", new { listingId = Model.AppraisalGenerateId }) %>">
            ...
            <div id="listImages">
            	<h3><b style="color: white; font-size: 1em;">Customer Information</b></h3>
                    ...
                    <div class="label">Email: </div><%=Html.TextBoxFor(x => x.CustomerEmail, new { @class = "z-index" })%>		
                    <br /><br />
                    ...
                    <input type="button" class="pad" name="print" id="PrintAppraisal" onclick="window.print()" value="Print Appraisal" />
                  ...
                  $(this).fancybox({
                      ...
                      'onCleanup': function () {
                          ...
                          if ($("#NeedToReloadPage").val() == 'true') {
                              ...
                              $.ajax({
                                  type: "GET",
                                  url: "/Appraisal/KarPowerDataOnMobile?listingId=" + '<%= Model.AppraisalGenerateId %>',
                                  data: {},
                                  dataType: 'html',
