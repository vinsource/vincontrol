...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="clear">
        <%=Html.ReportButtonGroupForAppraisalForTruck()%>
    </div>
    <div id="detailWrap">
        ...
        <div id="profileInfo">
            ...
            <ul class="column">
                ...
                <li style="width: 140px;">
                    <%=  Html.DynamicHtmlLabel("txtLabelLocation", "Location")%></li>
            </ul>
            <ul class="column">
                <li>
            ...
            <div id="carfax" style="overflow: hidden;">
                ...
                <div id="report-wrapper" style="width: 100%;">
                    <div id="history-report" style="clear: both; float: left; width: 100%;">
                        ...
                        <a class="iframe" href="http://www.carfaxonline.com/cfm/Display_Dealer_Report.cfm?partner=VIT_0&UID=<%=Model.CarFaxDealerId%>&vin=<%=Model.VinNumber%>"
                            target="_blank" style="float: right;">View Full Report</a>
                    </div>
                </div>
    ...
    <div id="c3" class="column hehe">
        <div id="listImages">
            ...
            <%=Html.TextBoxFor(x => x.CustomerEmail, new { @class = "z-index" })%>
            <br />
            <br />
            <div class="label">
                <b style="color: white; font-size: 1.1em;">ACV</b>:
            </div>
