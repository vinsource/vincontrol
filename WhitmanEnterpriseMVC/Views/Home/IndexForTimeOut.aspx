...
<head>
    ...
    <style type="text/css">
      html, body {background: #000000; font-family: 'Trebuchet MS', Arial, sans-serif;}
      .well {border: none;}
      .hero-unit {
        text-align: center;
        overflow: hidden;
      ...
      #login-form {position: absolute; left: 0; right: 0; bottom: 0; margin:0; background: #222;}
...
<body>
    <div class="container" style="padding-top:0px;">
        <div class="row">
            <div style="color:White;margin: 5px 0; font-size: 15px; font-weight: bold;">Please sign in again.</div>
            <div style="color:White;margin: 5px 0; font-size: 15px;">For your security, you were signed out.</div>
            <div class="span9">
