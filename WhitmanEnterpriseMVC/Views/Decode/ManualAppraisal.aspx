...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="topNav">
        <input class="btn onadmin" type="button" name="inventory" value=" Car " id="btnCar" />
        <input class="btn" type="button" name="notifications" value=" Commercial Truck "
            id="btnTruck" />
    </div>
    <div class="column">
        <% Html.BeginForm("ViewProfileByManual", "Appraisal", FormMethod.Post, new { id = "viewProfileForm", onsubmit = "return validateForm()" }); %>
        <table>
            <tr>
                <td>
                    VIN
            ...
            <tr>
                ...
                <td>
                    <%=Html.TextBoxFor(x=>x.AppraisalDate) %>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedModelYear)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedMake)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedModel)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedTrim)%>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedCylinder)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedLiters)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedTranmission)%>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedBodyType)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedFuel)%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%=Html.TextBoxFor(x => x.SelectedDriveTrain)%>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            if ($("#SelectedMileageEx").length > 0) {
                $("#SelectedMileageEx").remove();
            }

            if ($("#SelectedExteriorColorEx").length > 0) {
                $("#SelectedExteriorColorEx").remove();
            }
            ...
            if ($("#SelectedModelYear").val() == "") {
                ...
                else if ($("#SelectedModelYear").val()>year+1)
                {
                    $("#SelectedModelYear").parent().append("<strong id='SelectedModelYearWrongFormatEx'><font color='Red'>Less than next year value only</font></strong>");
                    flag = false;
                }
            }
            if ($("#SelectedMake").val() == "") {
            ...
            if ($("#Mileage").val() == "") {
                $("#Mileage").parent().append("<strong id='SelectedMileageEx'><font color='Red'>Required</font></strong>");
                flag = false;
            }

            if ($("#ExteriorColor").val() == "") {
                $("#ExteriorColor").parent().append("<strong id='SelectedExteriorColorEx'><font color='Red'>Required</font></strong>");
                flag = false;
            }
