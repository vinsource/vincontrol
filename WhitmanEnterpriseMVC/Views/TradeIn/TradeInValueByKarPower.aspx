    ...
    <div id="container" class="step5">
		...
		<div class="slide-wrapper">
					...
					<div class="row">
						<div id="chart" class="row-cell">
							...
							<div class="prices">
									...
									<%if (String.IsNullOrEmpty(Model.TradeInFairPrice) || Model.TradeInFairPrice.Equals("NA"))
           { %>
           ...
           else
           {
									...
									<%} %>
									<%if (String.IsNullOrEmpty(Model.TradeInGoodPrice) || Model.TradeInGoodPrice.Equals("NA"))
           { %>
		...
		<div class="controls">
			<a href="<%=Url.Content("~/TradeIn/TradeInVehicleByKarPower?dealer=" ) %><%=Model.Dealer %>" class="prev" >Appraise a New Vehicle?</a>
		</div>
	</div>
