        ...
        $(document).ready(function() {
            $("#btnKPIPrint").click(function() {
                ...
                if ($("#pdfChoice").attr('checked')) {
                    window.location = '<%= Url.Action("ViewKPIReport", "Market", new { reportType = WhitmanEnterpriseMVC.HelperClass.ReportType.Pdf }) %>';
                    
                }
                else {
                    window.location = '<%= Url.Action("ViewKPIReport", "Market", new { reportType = WhitmanEnterpriseMVC.HelperClass.ReportType.Excel }) %>';
