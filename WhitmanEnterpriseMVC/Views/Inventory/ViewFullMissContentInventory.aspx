...
<input type="hidden" id="IsEmployee" name="IsEmployee" value="<%= (bool)Session["IsEmployee"]%>" />
    <div id="recent">
        ...
        <h3 id="invenHeader">
            Number of Cars =<%=Model.CarsList.Count.ToString(CultureInfo.InvariantCulture) %></h3>
        <div id="tableHeader" style="margin-left: 20px;">
            <div class="rowOuter">
                <div class="innerRow1 clear">
                    ...
                    <% if (Model.IsMissingContent)
                      { %>
                    <div id="switch-view" title="Switch to Large Cells">
                        <a href="<%= Url.Content("~/Inventory/MissContentSmallInventory") %>">
                      ...
                      {
                          %>
                        <div id="Div1" title="Switch to Large Cells">
                        <a href="<%= Url.Content("~/Inventory/NoContentSmallInventory") %>">
                            <img src='<%= Url.Content("~/Images/small-view.jpg") %>' />
                        </a>
                    </div>
                      <%} %>
