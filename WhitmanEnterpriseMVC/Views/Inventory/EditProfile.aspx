        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <%-- <%= Html.TextBoxFor(x => x.Trim, new { @class = "z-index" })%>--%>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <%=Html.DropDownListFor(x => x.SelectedExteriorColorCode, Model.ChromeExteriorColorList)%>
            ...
            <tr>
                ...
                <td>
                        ...
                        <% if (Model.VinDecodeSuccess) {%>
                         <%= Html.TextBoxFor(x => x.Cylinder, new { @class = "small", @readonly = "readonly" })%>
            ...
            <tr>
                ...
                <td>
                        <% if (Model.VinDecodeSuccess) {%>
                         <%= Html.TextBoxFor(x => x.Litters, new { @class = "small", @readonly = "readonly" })%>
    ...
    <div class="column" id="column-two" style="font-size: 0.9em;">
        ...
        <input class="pad" type="submit" name="CancelIProfile" value=" Cancel " id="CancelIProfile" />
          <% if ((bool) Session["IsEmployee"] == false)
                             { %>
        <input class="pad" type="submit" name="SaveIProfile" value=" Save Changes " id="SaveIProfile"  />
          <% } %>
        ...
        $(document).ready(function () {
            ...
            $("#SelectedVehicleType").change(function (e) {
                ...
                if (VehicleType == 'Truck') {
                    var actionUrl = '<%= Url.Action("EditIProfileForTruck", "Inventory", new { ListingID = "PLACEHOLDER" } ) %>';
