            ...
            <div class="rowOuter">
                <div class="innerRow1 clear">
                    <div class="start cell column">
                        <%= Html.ActionLink("Stock", "SortSmallLoanerInventory", "Inventory", new { id = "Stock" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Year", "SortSmallLoanerInventory", "Inventory", new { id = "Year" }, null)%>
                    </div>
                    <div class="long cell column">
                        <%= Html.ActionLink("Make", "SortSmallLoanerInventory", "Inventory", new { id = "Make" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Model", "SortSmallLoanerInventory", "Inventory", new { id = "Model" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Trim", "SortSmallLoanerInventory", "Inventory", new { id = "Trim" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.ActionLink("Color", "SortSmallLoanerInventory", "Inventory", new { id = "Color" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.ActionLink("Owners", "SortSmallLoanerInventory", "Inventory", new { id = "Owners" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Age", "SortSmallLoanerInventory", "Inventory", new { id = "Age" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Miles", "SortSmallLoanerInventory", "Inventory", new { id = "Miles" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Price", "SortSmallLoanerInventory", "Inventory", new { id = "Price" }, null)%>
                    </div>
