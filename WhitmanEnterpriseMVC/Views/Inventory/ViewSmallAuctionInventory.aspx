            ...
            <div class="rowOuter">
                <div class="innerRow1 clear">
                    <div class="start cell column">
                        <%= Html.ActionLink("Stock", "SortSmallAuctionInventory", "Inventory", new { id = "Stock" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Year", "SortSmallAuctionInventory", "Inventory", new { id = "Year" }, null)%>
                    </div>
                    <div class="long cell column">
                        <%= Html.ActionLink("Make", "SortSmallAuctionInventory", "Inventory", new { id = "Make" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Model", "SortSmallAuctionInventory", "Inventory", new { id = "Model" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Trim", "SortSmallAuctionInventory", "Inventory", new { id = "Trim" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.ActionLink("Color", "SortSmallAuctionInventory", "Inventory", new { id = "Color" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.ActionLink("Owners", "SortSmallAuctionInventory", "Inventory", new { id = "Owners" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Age", "SortSmallAuctionInventory", "Inventory", new { id = "Age" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Miles", "SortSmallAuctionInventory", "Inventory", new { id = "Miles" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Price", "SortSmallAuctionInventory", "Inventory", new { id = "Price" }, null)%>
                    </div>
