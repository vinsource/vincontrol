...
#table {position: relative; left: .5em; font-size: 9.5pt; word-spacing: -1px; width: 760px;}
...
.infoCell {width: 750px !important;}
...
<input type="hidden" id="IsEmployee" name="IsEmployee" value="<%= (bool)Session["IsEmployee"]%>" />
               ...
               <div id="other" style="float:right; margin-top:-25px;">
                 <%if (Model.CurrentOrSoldInventory)
                     {%>
                <b id="soldVehicles" style="float:right; cursor: pointer;"><%= Html.ActionLink("View Sold Vehicles", "ViewNewSoldInventory", "Inventory")%></b>
                <% }
                     else
                     { %>
                <b id="B1" style="float:right; cursor: pointer;"><%= Html.ActionLink("View Current Vehicles", "ViewNewInventory", "Inventory")%></b>
                <% } %>
                ...
                <div id="color1" style="margin-top: 2px; margin-right: .5em; float:left; clear:right; padding:.2em; border: 1px solid yellow">     	<%= Html.ActionLink("Missing Content", "MissContentNewSmallInventory", "Inventory")%></div>
                <div id="color2" style="margin-top: 2px; margin-right: .5em; padding:.2em; float:left; clear:right; border: 1px solid red">     	<%= Html.ActionLink("No Content", "NoContentNewSmallInventory", "Inventory")%></div></div>
                </div>
                <h3 id="invenHeader">Number of Cars  = <%=Model.CarsList.Count(x => x.IsSold == false)%></h3>
                <div id="tableHeader" style="margin-left: 20px;">
                   ...
                   <div id="switch-view" title="Switch to Large Cells">
                                 <a   href="<%=Url.Content("~/Inventory/ViewFullNewInventory")%>">
                ...
                <% }
                     ...
                     { %>
                 <div id="switch-view" title="Switch to Large Cells">
                                 <a   href="<%=Url.Content("~/Inventory/ViewFullNewSoldInventory")%>">
                                    <img src=<%=Url.Content("~/Images/small-view.jpg")%> />
                                </a>
                            </div>
                <% } %>
