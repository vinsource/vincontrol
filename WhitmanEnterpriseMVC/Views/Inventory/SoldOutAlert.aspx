...
<h2>Previous Sold Vehicle Alert</h2>
<div id="container">
	
<div id="space" class="label">This <%= ViewData["Year"]%> <%=ViewData["Make"]%>  <%=ViewData["Model"]%>  <%=ViewData["Trim"]%>  was sold on  <%=ViewData["DateInStock"]%></div> 
...
<input type="submit" name="MarkUnSoldFromVinDecode"  value="Mark UnSold"  />
<input type="submit" name="NewAppraisal"  value="New Appraisal"  />
  <% Html.EndForm(); %>
