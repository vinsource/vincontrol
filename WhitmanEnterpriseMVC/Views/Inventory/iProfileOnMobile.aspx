...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--<script src="<%=Url.Content("~/js/jquery-1.6.1-vsdoc.js")%>" type="text/javascript"></script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div id="mInfo">
                    <ul id="mInfoList">
                        <li>
                            ...
                            <%=Html.DynamicHtmlControlForIprofile("ListingId",
                                                                                                   "hiddenListingId")%>
    ...
    <div id="c3" class="column">
        ...
        <%--<input id="save" class="pad" type="button" name="submit" value="Save" />--%>
    ...
    <script type="text/javascript">
        ...
        //$("a[id='PriceTracking']").live('click', function (e) {
        //    $(this).fancybox({
        //        href: '/Inventory/ViewPriceTracking?ListingId=' + $('#ListingId').val(),
        //        'width': 1000,
        //        'height': 700,
        //        'hideOnOverlayClick': false,
        //        'centerOnScroll': true,
