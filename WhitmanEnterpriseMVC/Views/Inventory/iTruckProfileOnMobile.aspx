...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input class="z-index" type="hidden" id="hiddenPhotoOrder" name="hiddenPhotoOrder"
        value="" />
    <div id="topNavBTN" class="clear" style="width: 600px; overflow: hidden;">
        <%=Html.ReportButtonGroupForTruck()%>
    ...
    <div id="detailWrap">
        <div id="images" class="column">
            ...
            <div style="text-align: center">
                <% if (Model.PreviousListingId != -1)
                   { %>
                <a href="<%= Url.Action("ViewIProfile", "Inventory", new { ListingID = Model.PreviousListingId }) %>">
                    Previous </a>
                <%}
        ...
        <div id="profileInfo">
            ...
            <ul class="column">
                ...
                <li>
                    <%=  Html.DynamicHtmlLabel("txtLabelTruckType", "TruckType")%></li>
                <li>
                    <%=  Html.DynamicHtmlLabel("txtLabelTruckClass", "TruckClass")%></li>
            </ul>
            <ul class="column">
                <li>
                ...
                <li>
                    <%=  Html.DynamicHtmlLabel("txtLabelTruckCategory", "TruckCategory")%></li>
                <li>
            ...
            <div id="description" class="clear">
                <h4>
                    Description</h4>
                <p class="top">
                    <%=  Html.DynamicHtmlLabel("txtLabelDescription", "Description")%></p>
                <p class="bot">
                </p>
                <div id="mInfo">
                    <ul id="mInfoList">
                        <li>
                            <h2 class="subtext acv">
                                ACV</h2>
                            <%if (HTMLControlExtension.CanSeeButton(Model,Constanst.ProfileButton.ACV))
                              {%>
                            <h1 title="Click to change this info." id="acvTitle" class="green acv">
                            </h1>
                            <% Html.BeginForm("UpdateACV", "Inventory", FormMethod.Post, new { id = "SaveACVForm" });%>
                            <input class="green" style="width: 110px !important; font-size: 2.0em; overflow: hidden;
                                display: block; color: #66FE00 !important; background: #222 !important;" type="text"
                                name="acv" id="txtACV" value="<%=Model.ACV %>">
                        ...
                        <li>
                            <h2 class="subtext">
                              ...
                              {%>
                            <h1 title="Click to change this info." id="costTitle" class="green cost">
                            </h1>
                            <% Html.BeginForm("UpdateDealerCost", "Inventory", FormMethod.Post, new { id = "SaveDealerCostForm" });%>
                            <input type="text" class="green" style="width: 110px !important; font-size: 2.0em;
                                overflow: hidden; display: block; color: #66FE00 !important; background: #222 !important;"
                                name="dealerCost" id="txtDealerCost" value="<%=Model.DealerCost %>">
                            <%= Html.DynamicHtmlControlForIprofile("ListingId", "hiddenListingId")%>
                            <input class="cost" style="width: 110px !important;" type="submit" name="costBTN"
                                value=" Save " />
                            <% Html.EndForm(); %>
                            <%
                              }%>
                        ...
                        <li>
                            <h2 class="subtext">
                                Sale Price</h2>
                            <h1 title="Click to change this info." id="saleTitle" name="saleTitle" class="green sale">
                            </h1>
                            <% Html.BeginForm("UpdateSalePrice", "Inventory", FormMethod.Post, new { id = "SaveSalePriceForm" });%>
                            <input type="text" class="green" style="width: 110px !important; font-size: 2.0em;
                                overflow: hidden; display: block; color: #66FE00 !important; background: #222 !important;"
                                name="salePrice" id="txtSalePrice" value="<%=Model.SalePrice %>">
                            <%= Html.DynamicHtmlControlForIprofile("ListingId", "hiddenListingId")%>
                            <%if ((bool)Session["IsEmployee"] == false)
                              {%>
                            <input class="sale" style="width: 110px !important;" type="submit" name="saleBTN"
                                value=" Save " />
                            <%
                              }%>
                            <% Html.EndForm(); %>
            ...
            <div id="graph" class="column" style="font-size: .8em;">
                <div id="rangeNav">
                    <input type="button" style="margin-left: 0;" id="graphButton" name="toggleGraph"
                        value="Expand" />
                    <%--Within (mi): California--%>
                    <span id="txtDistance">Within (100 miles) from your location</span>
                    <!--<span id="100" class="sortMiles rSelected">100</span> | <span id="250" class="sortMiles">250</span> | <span id="500" class="sortMiles">500</span> | <span id="any" class="sortMiles">Any</span>-->
                </div>
                <div id="graphWrap">
        ...
        <div id="references">
            ...
            <div id="carfax" style="overflow: hidden;">
                <div id="carfax-header" style="display: block; width: 100%;">
                    <a class="iframe" href="http://www.carfax.com/VehicleHistory/p/Report.cfx?vin=<%=Model.Vin%>"
                        target="_blank">
                ...
                <div id="report-wrapper" style="width: 100%;">
                    <div id="history-report" style="clear: both; float: left; width: 100%">
                        ...
                        <a class="iframe" href="http://www.carfax.com/VehicleHistory/p/Report.cfx?vin=<%=Model.Vin%>"
                            style="float: right; font-weight: normal; font-size: .9em;" target="_blank">View
                            Full Report</a>
                    </div>
                </div>
            ...
            <div id="manheim">
                ...
                <div class="partialContents" data-url="<%= Url.Action("ManheimDataOnMobile", "Inventory", new { Model.ListingId,Model.InventoryStatus }) %>">
            ...
            <div id="mkWrap">
                <div id="kbb">
                    ...
                    <a class="iframe" style="display: inline-block; cursor: pointer; height: 17px; font-size: .7em"
                        title="DMV Desk" href="https://secure.dmvdesk.com/dmvdesk/"><span style="position: relative;
                            top: -5px;">DMV Desk</span> </a><a class="iframe" style="display: inline-block; cursor: pointer;
                                height: 17px; font-size: .7em" title="KSR" href="   https://www.dmvlink.com/online/terminal.asp">
                                | <span style="position: relative; top: -5px;">KSR</span> </a>
                    <div id="divPartialKbb" class="partialContents" data-url="<%= Url.Action("KarPowerDataOnMobile", "Inventory", new { Model.ListingId,Model.InventoryStatus }) %>">
                    ...
                    <%--<div id="bb" class="hider">
                                    ...
                                    <a class="iframe" style="display: inline-block; cursor: pointer; margin-top: 8px;
                                        ...
                                        title="MMR Auction Pricing" href="<%=Url.Content("~/Report/ViewManheimReport?ListingId=")%><%=Model.ListingId%>">
    ...
    <div id="c3" class="column">
        ...
        <input id="delete" class="pad" type="button" name="submit" value="Delete" />
        <br />
        <br />
        <div id="photos">
            <ul id="listImages">
    ...
    <script type="text/javascript">
        ...
        var requestUrl = '<%= Url.Action("GetMarketDataByListingWithin100MilesRadius", "chart", new { ListingId = "PLACEHOLDER" } ) %>';
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#btnHeadWholesale").click(function () {
                if (confirm("Are you sure to whole sale this vehicle?")) {
                    return true;
                }
                else
                    return false;
            ...
            //            $.post('<%= Url.Content("~/Inventory/GetImages") %>', { id: '<%=Model.ListingId %>', status: '<%=Model.InventoryStatus %>' }, function (data) {
        ...
        $('input[name="edit"]').click(function () {
            ...
            //	         $('input[name="ebayCraigslist"]').slideToggle("slow");
            //	         $('input[name="print"]').slideToggle("slow");
            //	         $('input[name="bg"]').slideToggle("slow");
            //	         $('input[name="ws"]').slideToggle("slow");
            //	         $('input[name="sold"]').slideToggle("slow");
            //	         $('input[name="wholesale"]').slideToggle("slow");
            $("#iProfileForm").change(function () {
                flag = true;
            });
            ...
            if (flag) {
                ...
                $("#txtLabelTruckCategory").text($("#SelectedTruckCategory").val());
                $("#txtLabelTruckType").text($("#SelectedTruckType").val());
                $("#txtLabelTruckClass").text($("#SelectedTruckClass").val());
                ...
                $.post('<%= Url.Content("~/Inventory/UpdateITruckProfile") %>', { ListingId: $("#hiddenListingID").val(), Vin: $("#txtEditVin").val(), StockNumber: $("#txtStock").val(), ModelYear: $("#txtYear").val(), Make: $("#txtMake").val(), Model: $("#txtModel").val(), ExteriorColor: finalExteriorColor, InteriorColor: finalInteriorColor, Trim: trim, Mileage: mileage, Tranmission: $("#txtTranmission").val(), Cylinders: $("#txtCylinders").val(), Liters: $("#txtLitters").val(), Doors: $("#txtDoors").val(), Style: $("#txtBodyType").val(), Fuel: $("#txtFuelType").val(), Drive: $("#txtDriveType").val(), Description: $("#txtDescription").val(), Options: finalOptions, MSRP: $("#txtMSRP").val(), Certified: CertifiedCheck, PriorRental: PriorRentalCheck, TruckType: $("#SelectedTruckType").val(), TruckClass: $("#SelectedTruckClass").val(), TruckCategory: $("#SelectedTruckCategory").val(), RetailPrice: $("#txtRetailPrice").val(), DiscountPrice: $("#txtDealerDiscount").val(), ManufacturerRebate: $("#txtManufacturerRebate").val() }, function (data) {
                    flag = false;
                    //console.log(data);
                });
        ...
        function getSelectedPackages() {
            ...
            for (var i = 0; i < totalPackages.length; i++) {
                if (totalPackages[i].checked) {
                    ...
                    result += totalPackages[i].value.substring(0, totalPackages[i].value.indexOf("$")) + ",";
                }
            }
        ...
        function getSelectedOptions() {
            ...
            for (var i = 0; i < totalOptions.length; i++) {
                if (totalOptions[i].checked)
                    result += totalOptions[i].value.substring(0, totalOptions[i].value.indexOf("$")) + ",";
            }
        ...
        var currentheight = 0;
        var count = 0;
        //        if( document.getElementById('listImages').getElementsByTagName('li')) {
        //            count = document.getElementById('listImages').getElementsByTagName('li').length;
        //        }
        ...
        $('#description').dblclick(function () {
            //console.log($("#dropdownWrap").attr("style"));
            if ($("#dropdownWrap").attr("style") == "display: none; ") {
                $('input[name="edit"]').val("Save");
            }
            else {
                $('input[name="edit"]').val("Edit");
