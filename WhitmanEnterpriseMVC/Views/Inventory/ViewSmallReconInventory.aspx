    ...
    <div id="recent">
        ...
        <div id="other" style="float: right; margin-top: -25px;">
            ...
            <b id="TodayBucketJump" style="float: left; cursor: pointer;">
                ...
                &nbsp;&nbsp; </b><b id="expressBucketJump" style="float: right; cursor: pointer;">
            ...
            <div class="rowOuter">
                <div class="innerRow1 clear">
                    <div class="start cell column">
                        <%= Html.ActionLink("Stock", "SortSmallReconInventory", "Inventory", new { id = "Stock" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Year", "SortSmallReconInventory", "Inventory", new { id = "Year" }, null)%>
                    </div>
                    <div class="long cell column">
                        <%= Html.ActionLink("Make", "SortSmallReconInventory", "Inventory", new { id = "Make" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Model", "SortSmallReconInventory", "Inventory", new { id = "Model" }, null)%>
                    </div>
                    <div class="mid cell column">
                        <%= Html.ActionLink("Trim", "SortSmallReconInventory", "Inventory", new { id = "Trim" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.ActionLink("Color", "SortSmallReconInventory", "Inventory", new { id = "Color" }, null)%>
                    </div>
                    <div class="short cell column">
                        <%= Html.Label("Recon")%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Age", "SortSmallReconInventory", "Inventory", new { id = "Age" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Miles", "SortSmallReconInventory", "Inventory", new { id = "Miles" }, null)%>
                    </div>
                    <div class="shorter cell column">
                        <%= Html.ActionLink("Price", "SortSmallReconInventory", "Inventory", new { id = "Price" }, null)%>
                    </div>
                </div>
                <div class="clear">
                </div>
        ...
        <%=Html.DynamicHtmlLabelForInventory("SmallReconInventoryGrid")%>
    </div>
