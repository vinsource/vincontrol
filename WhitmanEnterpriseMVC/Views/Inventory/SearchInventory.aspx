...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
               ...
               <div id="other" style="float:right; margin-top:-25px;">
                ...
                <div id="color2" style="margin-top: 2px; margin-right: .5em; padding:.2em; float:left; clear:right; border: 1px solid red">     	<%= Html.ActionLink("No Content", "NoContentInventory", "Inventory")%></div></div>
                </div>
