...
namespace WhitmanEnterpriseMVC.Models
{
    ...
    public class KarPowerSavedDataViewModel
    {
        public string SavedModel { get; set; }
        public string SavedTrim { get; set; }
        public string SavedOptionIds { get; set; }
        public int SavedTrimId { get; set; }
        public int SavedEngineId { get; set; }
        public int SavedTransmissionId { get; set; }
        public int SavedDriveTrainId { get; set; }
    }
}