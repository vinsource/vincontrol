...
using WhitmanEnterpriseMVC.com.nationalautoresearch.www;
...
namespace WhitmanEnterpriseMVC.HelperClass
{
    public sealed class BlackBookService
    {
        ...
        public static BlackBookViewModel GetDirectFullReport(string Vin, string Mileage, string State)
        {
            BlackBookViewModel blackbook = new BlackBookViewModel()
            {
                Vin = Vin
        ...
        public static BlackBookViewModel GetFullReport(string Vin, string Mileage, string State)
        {
