    ...
    public class SelectListHelper
    {
        ...
        public static IEnumerable<SelectListItem> InitialDealerList(DealerGroupViewModel dealerGroup)
        {
            ...
            foreach (DealershipViewModel dealer in dealerGroup.DealerList)
            {
                ...
                returnList.Add(SelectListHelper.CreateSelectListItem(dealer.DealershipName, dealer.DealershipId.ToString(), false));


            }

            returnList.Add(SelectListHelper.CreateSelectListItem(dealerGroup.DealershipGroupName, "999", false));
        ...
        public static IEnumerable<SelectDetailListItem> InitalFactoryPackagesOrOption(List<ExtendedFactoryOptions> list)
        {
            ...
            if (list != null && list.Any())
            {
                ...
                {
                    returnList.Add(CreateSelectListItem(package.getName() + " " + package.getMSRP(), package.getName() + package.getMSRP(), package.Description, false));
                }
