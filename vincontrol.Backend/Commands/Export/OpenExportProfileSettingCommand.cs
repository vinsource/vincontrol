...
{
    public class OpenExportProfileSettingCommand : CommandBase
    {
        private ExportProfileViewModel _vm;
        public OpenExportProfileSettingCommand(ExportProfileViewModel vm)
            : base(null)
        {
            _vm = vm;
        }
        ...
        {
            var chldWindow = new ExportProfileTemplateMappingWindow(_vm,null);
