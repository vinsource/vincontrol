...
$(document).ready(function () {
    ...
    $(".v3BrandOther_btn_item").live("click", function () {
        $(this).parent().find(".v3BrandOther_btn_item").removeClass("v3BrandOther_btn_itemActive");
    ...
    $('#ddlMake').live('change', function() {
        ...
        var dataUrl = '/StockingGuide/StockingGuideOtherBrandJson?make=' + selectedMake + '&model=' + selectedModel;
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: dataUrl,
            ...
            success: function(result) {
                ...
                if (selectedMake != '') {
                    ...
                    $(".v3BrandOther_Segments_Detail").each(function() {
                        if ($(this).parent().find("div[id^='divStock_']").text() == '0')
                            $(this).parent().hide();
                        else {
                            $(this).parent().find(".v3BrandOther_Segments_Detail").show();
                            $(this).parent().find(".v3BrandOther_Segments_Detail").find("div[id^='v3BrandOtherInventory']").addClass('v3BrandOther_btn_itemActive');
                            $(this).parent().find("div[id^='SDTableInventory_']").show();
                            $(this).parent().find("div[id^='SDTableMarket_']").hide();
                        }
                    });
                }
