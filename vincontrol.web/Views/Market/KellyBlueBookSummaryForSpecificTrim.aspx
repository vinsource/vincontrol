...
<% Html.BeginForm("GetKellyBlueBookSummaryAdjustMileageForSpecificTrim", "Market", FormMethod.Post, new { id = "KellyBlueBookForm" }); %>
 ...
 <% Html.EndForm(); %>
         <table style="font-size: .8em">
                    <tr>
                        ...
                        <td><input class="pad_tab"  type="button" name="PrintKbbReport" id=<%=Model.TrimReportList.First().VehicleId  %> value="Print" onclick="javascript:SubmitPrintForm(<%=Model.TrimReportList.First().VehicleId  %>,<%=Model.TrimReportList.First().TrimId  %>)" /></td>
                    </tr>
...
<script language="javascript">
    $("#btnSaveKbbOption").click(function(event) {
        ...
        $.post('<%= Url.Content("~/Inventory/SaveKBBOptions") %>', { ListingId: $("#ListingId").val(), OptionSelect: itemoption, TrimId: $("#TrimId").val(), BaseWholeSale: baseWholeSaleNumber, WholeSale: wholeSaleNumber, MileageAdjustment: mileageAdjustment }, function(data) {
