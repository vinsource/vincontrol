<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Vincontrol.Web.Models.BlackBookViewModel>" %>
...
<div id="kbb" class="wrapper">
	<table>
		<tr>
		   ...
		   <%foreach (Vincontrol.Web.Models.BlackBookTrimReport trimReport in Model.TrimReportList)
       {%>
		<tr>
