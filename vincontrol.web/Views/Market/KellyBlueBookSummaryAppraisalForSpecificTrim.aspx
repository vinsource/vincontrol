...
<% Html.BeginForm("GetKellyBlueBookSummaryAdjustMileageForSpecificTrimInAppraisal", "Market", FormMethod.Post, new { id = "KellyBlueBookForm" }); %>
	...
	<table>
       ...
       <tr>
		...
		<tr>
		   ...
		   <td class="excellent" colspan="3"><label id="lblBaseWholeSale"><%=trimReport.BaseWholesale%></label> + <%=trimReport.MileageAdjustment.ToString()%></td>
		   
		   <td class="excellent"><label id="lblWholeSale"><%=trimReport.WholeSale %></label></td>
		...
		<tr>
		 ...
		 <tr>
		   ...
		   <td class="excellent" colspan="3"><label id="lblBaseRetail"><%=trimReport.BaseRetail%></label> + <%=trimReport.MileageAdjustment.ToString()%></td>
		   
		   <td class="excellent"><label id="lblRetail"><%=trimReport.Retail %></label></td>
	    </tr>
