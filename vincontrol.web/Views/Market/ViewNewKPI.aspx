...
<asp:Content ID="Content1" ContentPlaceHolderID="SubMenu" runat="server">
    <div id="admin_top_btns_holder">
        ...
        <% { %>
        <div id="btnPreowned" class="admin_top_btns">
            Pre-Owned
        </div>
        <% } %>
        ...
        <% { %>
        <div id="btnNew" class="admin_top_btns admin_top_btns_active">
            New
    ...
    <div id="container_right_btn_holder">
        <div id="container_right_btns">
            <div class="kpi_fixed_title">
                ...
                <input style="border:none;" class="save btns_shadow admin_save_change" type="submit" name="UpdateSetting" value="Save Changes" />--%>
            </div>
        </div>
    </div>
            ...
            <div class="kpi_list_holder">
                <div class="kpi_list_header">
                    ...
                    <a href="javascript:void(0);">
                        <div class="kpi_list_collum" style="width: 65px;padding-left: 24px;" id="kpisort_9" onmouseover="this.style.background='gray';"
                    ...
                    <a href="javascript:void(0);">
                        <div class="kpi_list_collum kpi_list_marketData" style="width: 55px;" id="kpisort_10" onmouseover="this.style.background='gray';"
                    ...
                    <a href="javascript:void(0);">
                        ...
                        <div class="kpi_list_collum_longHeader" style="width: 106px" id="kpisort_7" onmouseover="this.style.background='gray';"
                    ...
                    <a href="javascript:void(0);">
                        <div class="kpi_list_collum" style="width: 80px" id="kpisort_8" onmouseover="this.style.background='gray';"
...
<asp:Content ID="Content5" ContentPlaceHolderID="ClientTemplates" runat="server">
    <%=Html.Partial("_TemplateKPI",Model.CarsList)%>
</asp:Content>