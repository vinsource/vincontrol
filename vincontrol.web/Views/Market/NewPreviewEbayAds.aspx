            ...
            $("#PostButton").live('click', function () {
                ...
                $.post('<%= Url.Content("~/Market/PostEbayAds") %>', function (data) {
                    if (data == "TimeOut") {
                        ...
                        ShowWarningMessage("Thanks for using our ebay posting intergration on Vincontrol. Your ads is just posted on ebay successfully.");
								...
								<div class="ebay_clcf_input_holder">
									...
									<div class="ebay_clcf_input_items">
										...
										<div class="ebay_clcf_ii_val">
											...
											<input onblur="validateCalculateForm()" value="0" class="inputCal" type="text" id="ebay_cal_downpayment" />
										</div>
									</div>
									<div class="ebay_clcf_input_items">
										<div class="ebay_clcf_ii_key">
				...
				<div class="ebay_content_right">
                   ...
                   <div onclick="display_photo(<%=index %>);" class="ebay_cril_items">
                    ...
                    <%} %>
								...
								<div onmousedown="mouse_on=1;scroll_photo_list_down();"  onmouseup="scroll_photo_list_exit();" class="ebay_cril_topNextPre ebay_cril_topPre"><img src="/images/arrow2.png" />
								</div>
							</div>
