...
<body>
    ...
    <h2 class="invalid_vin_title">
        Pre-1982 Appraisal</h2>
    <div id="container">
        <div id="space" class="label">
            A year before 1982 has been entered. This will result in a manual appraisal process and significantly less data within VINControl. 
        ...
        <input type="button" name="BlankAppraisal" value="Continue Appraisal" id="btnContinue" onClick="parent.$.fancybox.close()"/>
