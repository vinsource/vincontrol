    ...
    <div id="container_right_btn_holder">
        <div id="container_right_btns">
            ...
            <div style="float: right">
                <select id="ddlMake" style="padding: 2px 4px;">
                    <option value="">Make</option>
                </select>
                <select id="ddlModel" style="padding: 2px 4px;">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ClientScripts" runat="server">
    ...
    <script src="<%=Url.Content("~/js/VinControl/StockingGuideBrandOther.js")%>" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ClientTemplates" runat="server">
    <%=Html.Partial("_TemplateBrandOther")  %>
