                                      ...
                                      <div class="ptr_items_content_items">
                                          ...
                                          <div class="ptr_items_content_value_auctionmore">
                                                ...
                                                <div class="ptri_content_value_text_auction_number">
                                                    <a id="linknation" style="color: blue; text-decoration:underline" class="iframe iframeManHeim"  href="/Chart/ManheimTransaction?listingId= {{:ListItems[0].ListingId}}&vehicleStatus= {{:ListItems[0].VehicleStatus}}&auctionRegion=1">
                                             ...
                                             <div class="ptri_content_value_text_auction_number-right">
                                               ...
                                               <div class="ptri_content_value_text_auction_number-right">
                                                   <a id="linkregion" style="color: blue; text-decoration:underline" class="iframe iframeManHeim"  href="/Chart/ManheimTransaction?listingId={{:ListItems[1].ListingId}}&vehicleStatus= {{:ListItems[0].VehicleStatus}}&auctionRegion=2">
