<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Vincontrol.Web.Models.CarDescriptionModel>" %>
            ...
            <div id="desc-wrap">
                ...
                <ul id="<%=tmp.Title.Replace(" ","") %>">
                    <%foreach (var des in tmp.Sentences.Where(x => x.YesNo).OrderBy(t => Guid.NewGuid()).ToList().Take(3))
                      {%>
                    <li>
                        <input type="radio" name="<%= tmp.Title %>" value="<%=des.DescriptionSentence %>" class="" /><%=des.DescriptionSentence %></li>
                ...
                <table style="font-size: .6em">
                    <tr>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Navigation System" class="" />Navigation System</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Panorama Sunroof" class="" />Panorama Sunroof</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Dual Power Seats" class="" />Dual Power Seats</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Rear View Camera" class="" />Rear View Camera</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Rear View Camera" class="" />Rear View Camera</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="AMG Performance package" class="" />AMG Performance package</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Panorama Moonroof" class="" />Panorama Moonroof</td>

                        <td>
                            <input type="checkbox" name="SelectOptions" value=">Electronic Trunk Close" class="" />Electronic Trunk Close</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Blind Spot Assist" class="" />Blind Spot Assist</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Parktronic With Parking Guidance" class="" />Parktronic With Parking Guidance</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Bi-xenon Active Headlamps" class="" />Bi-xenon Active Headlamps</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Heated Front Seats" class="" />Heated Front Seats</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Keyless" class="" />Keyless</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Power Rear Sunshade" class="" />Power Rear Sunshade</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="Sirius" class="" />Sirius</td>
                        <td>
                            <input type="checkbox" name="SelectOptions" value="iPod/Mp3 Media Interface" class="" />iPod/Mp3 Media Interface</td>
