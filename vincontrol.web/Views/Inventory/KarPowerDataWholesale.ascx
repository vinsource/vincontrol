...
<div class="karpowerTrim" id="Div1" <%= Model.FirstOrDefault().SelectedTrimName.Equals(Model.FirstOrDefault().SelectedTrimName) ? "" : "style='display:none'" %>>
    <div class="ptr_items_content_header">
        <div class="ptr_items_textInfo">
            <a style="color: black; text-underline: none" class="iframe iframeKBB" href="<%= Url.Action("GetSingleKarPowerSummaryForWholesale", "Market", new { listingId = ViewData["LISTINGID"], trimId = Model.FirstOrDefault().SelectedTrimId }) %>">
...
<div class="karpowerTrim" id="karpowerTrim_<%= Model.FirstOrDefault(i => i.IsSelected).SelectedTrimId %>">
    <div class="ptr_items_content_header">
        <div class="ptr_items_textInfo">
            <a style="color: black; text-underline: none" class="iframe iframeKBB" href="<%= Url.Action("GetSingleKarPowerSummaryForWholesale", "Market", new { listingId = ViewData["LISTINGID"], trimId = Model.FirstOrDefault(i => i.IsSelected).SelectedTrimId }) %>">
...
<div id="divMultipleKbbTrim">
    ...
    <div class="karpowerTrim" id="karpowerTrim_<%= item.SelectedTrimId %>" <%= item.SelectedTrimName.Equals(Model.FirstOrDefault().SelectedTrimName) ? "" : "style='display:none'" %>>
        <div class="ptr_items_content_header">
            ...
            <div class="ptr_items_textInfo">
                <a style="color: black; text-underline: none" class="iframe iframeKBB" href="<%= Url.Action("GetSingleKarPowerSummaryForWholesale", "Market", new { listingId = ViewData["LISTINGID"], trimId = item.SelectedTrimId }) %>">
