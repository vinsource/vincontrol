...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="recent">
        <div id="other" style="float: right; margin-top: -25px;">
            <b id="soldVehicles" style="float: right; cursor: pointer;">View Sold Vehicles</b>
            <div class="clear" style="font-size: .75em; float: right;">
                <div id="color0" style="margin-top: 2px; margin-right: .5em; float: left; clear: right; padding: .2em; border: 1px solid green">
                    <%= Html.ActionLink("A Cars", "ACarInventory", "Inventory")%>
                </div>
                <div id="color1" style="margin-top: 2px; margin-right: .5em; float: left; clear: right; padding: .2em; border: 1px solid yellow"><%= Html.ActionLink("Missing Content", "MissContentInventory", "Inventory")%></div>
                <div id="color2" style="margin-top: 2px; margin-right: .5em; padding: .2em; float: left; clear: right; border: 1px solid red"><%= Html.ActionLink("No Content", "NoContentInventory", "Inventory")%></div>
            </div>
        </div>
        <h3 id="invenHeader">Current Used Inventory = <%=Model.CarsList.Count(x => x.IsSold==false) %></h3>
        <div id="tableHeader">
            <div class="rowOuter">
        ...
        <%=Html.DynamicHtmlLabelForInventory("InventorySoldGrid")%>
    </div>
</asp:Content>
