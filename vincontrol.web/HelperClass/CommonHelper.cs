...
{
    public sealed class CommonHelperBAK
    {
        ...
        {
            return (dataString==null || String.IsNullOrEmpty(dataString.Trim())) ? new[] { "" } : dataString.Split(new[] { ',', '|' }, StringSplitOptions.RemoveEmptyEntries).ToArray();
        }
        ...
        //public static bool IsInventory(short? status)
        //{
        //    return status != Constanst.InventoryStatus.Wholesale && status != Constanst.InventoryStatus.Recon;
        //}
        ...
        public static Expression<Func<Inventory, bool>> IsNotWholdesale()
        {
            return e => e.InventoryStatusCodeId != Constanst.InventoryStatus.Wholesale;
        }
    }
}
