<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertifiednventoryReport.aspx.cs" Inherits="Vincontrol.Web.ReportTemplates.CertifiedInventoryReport" %>
...
<head runat="server">
    <title>Certified Inventory Report</title>
</head>
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="ReportTemplates\CertifiedInventoryReport.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="VinCertified" runat="server" 
            SelectMethod="GetCertifiedVehicles" 
