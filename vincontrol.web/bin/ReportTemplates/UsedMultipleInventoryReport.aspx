<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsedMultipleInventoryReport.aspx.cs" Inherits="Vincontrol.Web.ReportTemplates.MultpleUsedInventoryReport" %><%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Used Mutilple Inventory Report</title>
</head>
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="ReportTemplates\UsedMultipleInventoryReport.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="VinObject1" runat="server" 
            SelectMethod="GetVinControlUsedVehiclesMultipleStore" 
