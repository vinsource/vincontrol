    ...
    <div id="recent">
        <div id="other" style="float: right; margin-top: -25px;">
            ...
            <div class="clear" style="font-size: .75em; float: right;">
                ...
                <div id="color1" style="margin-top: 2px; margin-right: .5em; float: left; clear: right; padding: .2em; border: 1px solid yellow">
        ...
        <h3 id="invenHeader">Number of Cars =
            <%=Model.CarsList.Count().ToString() %></h3>
        <div id="tableHeader">
            <div class="rowOuter">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ClientScripts" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function updateSalePrice(txtBox) {
            $.post('<%= Url.Content("~/Inventory/UpdateSalePriceFromInventoryPage") %>', { SalePrice: txtBox.value, ListingId: txtBox.id, vehicleStatusCodeId: 2 }, function (data) {
