...
<script id="inventoryTemplate" type="text/x-jsrender">
   ...
   <a class="vin_editProfile" href="{{>URLEdit}}" title="{{>Trim}}">
        ...
        <div class="inventory_action_btns_new">
            {{if AllowBG }}
           ...
           <%-- <a title="Craigslist" href="javascript:;">
            ...
            {{if NotDoneBucketJump}}
                    <a id="doneTodayBucketJump_{{>ListingId}}_{{>DaysInInvenotry}}" name="doneTodayBucketJump_{{>ListingId}}_{{>DaysInInvenotry}}" title="Bucket Jump" style="margin-left:0px;" href="javascript:doneTodayBucketJump({{>ListingId}},{{>DaysInInvenotry}});">
