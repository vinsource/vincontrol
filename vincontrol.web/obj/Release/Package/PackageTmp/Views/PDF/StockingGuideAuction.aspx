...
<head runat="server">
    ...
    <title>Stocking Guide Auctions</title>
    <style type="text/css">
        html {
            ...
            <table id="tblVehicles" class="tablesorter" style="">
                ...
                <tbody>
                    <% for (int i = 0; i < Model.Count; i++)
                       {%>
                    <tr style="" >
                        <td style="width: 50px; text-align: center"><a href="<%=Model[i].ManheimVehicle.Url %>" target="_blank"><%=Model[i].ManheimVehicle.Year %></a></td>
                        <td style="width: 60px; text-align: center"><a href="<%=Model[i].ManheimVehicle.Url %>" target="_blank"><%=Model[i].ManheimVehicle.Make %></a></td>
                        <td style="width: 70px; text-align: center"><a href="<%=Model[i].ManheimVehicle.Url %>" target="_blank"><%=Model[i].ManheimVehicle.Model %></a></td>
