...
<body>
    <% Html.BeginForm("UpdateCustomerInfo", "Appraisal", FormMethod.Post, new { id = "CustomerInfoForm", name = "CustomerInfoForm" }); %>
    ...
    <div class="customerInfo_popup_holder profile_popup">
        ...
        <div class="customerInfo_popup_content">
            ...
            <div class="customerInfo_popup_items">
                ...
                <%=Html.TextBoxFor(x => x.Street, new { @class = "customerInfo_input" })%>
            </div>
            <div class="customerInfo_popup_items">
                <label>
                    Zip:
