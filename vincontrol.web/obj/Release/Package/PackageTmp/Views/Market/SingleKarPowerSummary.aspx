    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                ...
                url: '<%= Url.Action("HasKBBAuthorization", "Ajax")%>',
                        ...
                        success: function (result) {
                            if (result == 'False') {
                                ...
                                unblockUI();
                                GetValuation($('#txtInventoryId').val(), $('#txtVin').val(), $('#txtMileage').val(), $('#txtModel').val(), $('#txtTrim').val(), $('#txtType').val(), $('#txtHasVin').val());
                            }
                        },
                        error: function (err) {
                            $('#FailedAuthorization').show();
            ...
            $("#btnSave").live('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Market/SaveKarPowerOptions?inventoryid=" + $('#txtInventoryId').val() + "&vin=" + $('#txtVin').val() + "&modelId=" + $('#txtModel').val() + "&trimId=" + $('#txtTrim').val() + "&selectedOptionIds=" + selectedOptionIds + "&engineId=" + $("#SelectedEngineId").val() + "&transmissionId=" + $("#SelectedTransmissionId").val() + "&driveTrainId=" + $("#SelectedDriveTrainId").val() + "&baseWholesale=" + $("#baseWholesale").val() + "&wholesale=" + $("#wholesale").val() + "&type=" + $('#txtType').val(),
                    data: {},
                    dataType: 'html',
                    success: function () {
                        unblockUI();
        ...
        function GetValuation(inventoryid,vin, mileage, model, trim, type, hasVin) {
            blockUIPopUp();

            $.ajax({
                type: "POST",
                url: "/Market/KarPowerResultInSingleMode?inventoryid=" + inventoryid +"&vin=" + vin + "&mileage=" + mileage + "&modelId=" + model + "&trimId=" + trim + "&type=" + type + "&hasVin=" + hasVin,
                data: {},
                dataType: 'html',
                success: function (data) {
...
<body>
    ...
    <div>
        ...
        <div style="text-align:center;">
            <input type="hidden" name="txtInventoryId" id="txtInventoryId" value="<%= ViewData["INVENTORYID"] %>" />
