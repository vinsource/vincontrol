...
namespace vincontrol.Helper
{
    public sealed class CommonHelper
    {
        ...
        public static string RemoveSpecialCharactersForKBBWholesale(string input)
        {
        ...
        {
            return String.IsNullOrEmpty(dataString) ? new[] { "" } : dataString.Trim().Split(new[] { ',', '|' }, StringSplitOptions.RemoveEmptyEntries).ToArray();
        }
        ...
        public static int[] GetIntArrayFromString(string dataString)
        {
            return String.IsNullOrEmpty(dataString) ? null : dataString.Trim().Split(new[] { ',', '|' }, StringSplitOptions.RemoveEmptyEntries).Select(i => Convert.ToInt32(i)).ToArray();
        }
        ...
        public static int ConvertToInt32(JValue obj)
        {
        ...
        public static DateTime ConvertToDateTime(JValue obj)
        {
            return obj != null ? Convert.ToDateTime(obj.Value) : DateTime.Now;
        }

        public static List<ExtendedSelectListItem> CreateDataList(JToken obj, int selectedId)
        {
        ...
        public static string[] GetImagesFromString(string imageString)
        {
            return String.IsNullOrEmpty(imageString.Trim()) ? new[] { "" } : imageString.Split(new[] { ',', '|' }, StringSplitOptions.RemoveEmptyEntries).ToArray();
        }

        public static string GetSingleImageFromString(string imageString, string imageName)
        {
            var imageList = GetImagesFromString(imageString);
            return imageList.FirstOrDefault(i => i.ToLower().Contains(imageName.ToLower()));
        }
        ...
        public static string ReplaceEmails(string content, string textToReplace)
        {
        ...
        public static Expression<Func<Inventory, bool>> IsWholesalePredicate()
        {
            return i => i.InventoryStatusCodeId == Constanst.InventoryStatus.Wholesale;
        }

        public static Expression<Func<Inventory, bool>> IsInventoryPredicate()
        {
            return i => i.InventoryStatusCodeId == Constanst.InventoryStatus.Inventory;
        }

        public static Expression<Func<Inventory, bool>> IsNotReconPredicate()
        {
            return e => e.InventoryStatusCodeId != Constanst.InventoryStatus.Recon;
        }

        public static Expression<Func<Inventory, bool>> IsReconPredicate()
        {
            return e => e.InventoryStatusCodeId == Constanst.InventoryStatus.Recon;
        }
    }
