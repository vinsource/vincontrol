...
namespace vincontrol.DataFeed.Helper
{
    ...
    public sealed class CsvFile
    {
        ...
        {
            using (CsvReader reader = new CsvReader(filePath, encoding))
            {
                reader.HasHeaderRow = hasHeaderRow;
                reader.TrimColumns = trimColumns;
        ...
        {
            using (CsvReader reader = new CsvReader(stream, encoding))
            {
                reader.HasHeaderRow = hasHeaderRow;
                reader.TrimColumns = trimColumns;
                PopulateCsvFile(reader);
        ...
        {
            using (CsvReader reader = new CsvReader(encoding, csvContent))
            {
                reader.HasHeaderRow = hasHeaderRow;
                reader.TrimColumns = trimColumns;
                PopulateCsvFile(reader);
